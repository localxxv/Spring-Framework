...
public class Main {
    public static void main(String[] args) {
        IVehicleRepository vehicleRepository = new VehicleRepositoryImpl("vehicles.csv");
        IUserRepository userRepository = new UserRepository("users.csv");
        ...
        ConsoleUI ui = new ConsoleUI(vehicleRepository, userRepository);
        ui.start();
    }
}